    ...
    <form action="{{ route('cart.processCheckout') }}" method="POST" enctype="multipart/form-data">
        @csrf
            <div class="grid grid-cols-1 gap-6 md:grid-cols-2">
                ...
                <div class="flex flex-col">
                    <h2 class="text-2xl font-bold mb-4 text-white">Shipping Details</h2>
                    <div class="bg-white rounded-lg p-4">
                        <div class="mb-4">
                            <label for="pengiriman" class="block text-sm font-medium text-black">Pengiriman</label>
                            <select name="pengiriman" id="pengiriman" required class="mt-1 block w-full py-2 px-3 border border-gray-300 bg-white rounded-md focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm">
                        ...
                        <div class="mb-4">
                            <label for="payment_method" class="block text-sm font-medium text-black">Payment Method</label>
                            <select name="payment_method" id="payment_method" required class="mt-1 block w-full py-2 px-3 border border-gray-300 bg-white rounded-md focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm">
                        ...
                        <div id="qris-container" class="mb-4 hidden">
                            ...
                            <label for="payment_proof" class="block text-sm font-medium text-black mt-4">Upload Payment Proof</label>
                            <input type="file" name="payment_proof" id="payment_proof" class="mt-1 block w-full py-2 px-3 border border-gray-300 bg-white rounded-md focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm">
                        </div>
                        <div class="flex justify-end">
                            <button type="submit" class="bg-[#FE5F55] text-white px-4 py-2 rounded hover:bg-blue-700 focus:outline-none focus:bg-blue-700">Proceed to Payment</button>
                        </div>
                    </div>
                </div>
            </div>
